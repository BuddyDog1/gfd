...
{
  game_stauts="start";
  document.getElementById("stauts").innerHTML="Game is loaded"; 
...
function draw(){
if(game_stauts=="start") // inside the if condition check if the game_status is equal to the value "start".
{
  background(0); 
